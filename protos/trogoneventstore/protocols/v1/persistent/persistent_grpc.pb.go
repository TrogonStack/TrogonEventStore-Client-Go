...
const (
	...
	PersistentSubscriptions_TruncateParked_FullMethodName   = "/event_store.client.persistent_subscriptions.PersistentSubscriptions/TruncateParked"
...
type PersistentSubscriptionsClient interface {
	...
	TruncateParked(ctx context.Context, in *TruncateParkedReq, opts ...grpc.CallOption) (*TruncateParkedResp, error)
...
func (c *persistentSubscriptionsClient) TruncateParked(ctx context.Context, in *TruncateParkedReq, opts ...grpc.CallOption) (*TruncateParkedResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TruncateParkedResp)
	err := c.cc.Invoke(ctx, PersistentSubscriptions_TruncateParked_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PersistentSubscriptionsServer interface {
	...
	TruncateParked(context.Context, *TruncateParkedReq) (*TruncateParkedResp, error)
...
func (UnimplementedPersistentSubscriptionsServer) TruncateParked(context.Context, *TruncateParkedReq) (*TruncateParkedResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TruncateParked not implemented")
}
...
func _PersistentSubscriptions_TruncateParked_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TruncateParkedReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PersistentSubscriptionsServer).TruncateParked(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PersistentSubscriptions_TruncateParked_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersistentSubscriptionsServer).TruncateParked(ctx, req.(*TruncateParkedReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PersistentSubscriptions_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TruncateParked",
			Handler:    _PersistentSubscriptions_TruncateParked_Handler,
		},
		{
			MethodName: "List",
	...
	Metadata: "trogoneventstore/protocols/v1/persistent.proto",
}
