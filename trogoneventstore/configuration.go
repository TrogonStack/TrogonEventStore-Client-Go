...
// Configuration describes how to connect to an instance of TrogonEventStore.
type Configuration struct {
	// The URI of the TrogonEventStore. Use this when connecting to a single node.
	...
	// The username to use for authenticating against the TrogonEventStore instance.
	Username string

	// The password to use for authenticating against the TrogonEventStore instance.
	Password string
...
// ParseConnectionString creates a Configuration from a TrogonEventStore connection string.
