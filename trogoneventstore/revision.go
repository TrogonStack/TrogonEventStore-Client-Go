...
// TrogonEventStore server. The TrogonEventStore server will assure idempotency for all requests using any value in
// StreamState except Any. When using Any, the TrogonEventStore server will do its best to assure idempotency but
