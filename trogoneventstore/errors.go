...
// ErrorCode TrogonEventStore error code.
type ErrorCode int

const (
	// ErrorCodeUnknown unclassified error.
	ErrorCodeUnknown ErrorCode = iota
	// ErrorCodeUnsupportedFeature a request not supported by the targeted TrogonEventStore node was sent.
	...
	ErrorAborted
	// ErrorUnavailable when the TrogonEventStore node became unavailable.
	ErrorUnavailable
)
...
func (e *Error) Error() string {
	...
	case ErrorCodeUnsupportedFeature:
		msg = "[ErrorCodeUnsupportedFeature] request not supported by the targeted TrogonEventStore node"
