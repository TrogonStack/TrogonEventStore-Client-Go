...
const (
	...
	// TrogonEventStore inspects event for its source stream id, hashing the id to one of 1024 buckets assigned to
...
// FilterType  represents the type filters supported by TrogonEventStore.
type FilterType int
