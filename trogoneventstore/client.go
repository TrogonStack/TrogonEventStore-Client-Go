// Package trogoneventstore TrogonEventStore gRPC client.
...
import (
	...
	persistentProto "github.com/TrogonStack/TrogonEventStore-Client-Go/protos/trogoneventstore/protocols/v1/persistent"
	"github.com/TrogonStack/TrogonEventStore-Client-Go/protos/trogoneventstore/protocols/v1/shared"
	api "github.com/TrogonStack/TrogonEventStore-Client-Go/protos/trogoneventstore/protocols/v1/streams"
	"google.golang.org/grpc"
	"google.golang.org/grpc/metadata"
)

// Client Represents a client to a single node. A client instance maintains a full duplex communication to TrogonEventStore.
// Many threads can use a TrogonEventStore client at the same time or a single thread can make many asynchronous requests.
type Client struct {
	grpcClient *grpcClient
	config     *Configuration
}

// NewClient Creates a gRPC client to a TrogonEventStore database.
