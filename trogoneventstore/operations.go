...
// ServerVersion Represents the version of a TrogonEventStore node.
...
// GetServerVersion Returns the version of the TrogonEventStore node to which the client is currently connected.
